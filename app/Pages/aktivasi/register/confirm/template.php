            ...
            <div class="section mt-1 mb-5 px-0">
                <div>                    
                    ...
                    <div class="form-group px-3 mt-3">
                        <button type="button" x-on:click="confirm" class="btn btn-primary btn-block btn-lg" :class="confirming ? 'btn-progress' : ''">Konfirmasi</button>
                    </div>
                </div>
            </div>
        </div>
...
<?= $this->include('aktivasi/register/confirm/script') ?>