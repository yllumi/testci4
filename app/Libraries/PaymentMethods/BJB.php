...
class BJB extends XenditPaymentMethod {

	public $name = "BJB";
	public $label = "Transfer VA BJB";
	public $category = "Transfer Virtual Account (VA)";
	public $description = "Metode pembayaran menggunakan virtual account bank BJB";
	...
	public $thumbnail = "/mobilekit/assets/img/payment-methods/bjb.png";
