...
class Sampoerna extends XenditPaymentMethod {

	public $name = "SAHABAT_SAMPOERNA";
	public $label = "Transfer VA Bank Sampoerna";
	...
	public $thumbnail = "/mobilekit/assets/img/payment-methods/sampoerna.png";
